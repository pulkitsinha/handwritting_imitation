function [ Sequence,W ,K] = Check5( A ,a,b)% only applicable for thinned images////
...
if(E==1 )              % For 1 neigbour active
    if(C2==1)           %1 2 3 4 6 equivalent to 1 2 3 4 5 
      temp(1,2)=h-1;
      temp(2,2)=k-1;
      [F1,F2]=Neighbours(A,h-1,k-1,temp);
      G1= F1==1;
      G2=F2(G1);
      H=[6 4 1 2 3 7 5 8];
      I=PS(H,G2);
